<?php
/**
 * bivouak functions and definitions
 *
...
if ( ! function_exists( 'bivouak_setup' ) ) :
	/**
	 ...
	 */
	function bivouak_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on bivouak, use a find and replace
		 * to change 'bivouak' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'bivouak', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'bivouak_custom_background_args', array(
...
add_action( 'after_setup_theme', 'bivouak_setup' );
 ...
 */
function bivouak_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'bivouak_content_width', 640 );
}
add_action( 'after_setup_theme', 'bivouak_content_width', 0 );
...
add_action( 'widgets_init', 'bivouak_widgets_init' );
...
function bivouak_scripts() {
	...
	wp_enqueue_script( 'bivouak-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'bivouak_scripts' );
